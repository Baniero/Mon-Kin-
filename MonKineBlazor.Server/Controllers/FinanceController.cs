        ...
        try
        {
            ...
            cmd.CommandText = IsAdmin() ? @"
                SELECT
                    ...
                    COALESCE(pp.nb_seances, '0')::int,
                    COALESCE(pp.duree_seance_minutes, '0')::int,
                    pp.date_debut,
                    pp.date_fin,
            ...
            using (var reader = cmd.ExecuteReader())
            {
                while (reader.Read())
                {
                    programs.Add(new CnamProgramInvoiceDto
                    {
                        ...
                        Qualite = reader.GetString(6),
                        Titre = reader.GetString(7),
                        NatureSeances = reader.GetString(8),
                        NbSeances = reader.GetInt32(9),
                        DureeSeanceMinutes = reader.GetInt32(10),
                        DateDebut = reader.IsDBNull(11) ? null : reader.GetDateTime(11),
                        DateFin = reader.IsDBNull(12) ? null : reader.GetDateTime(12),
                        PrixUnitaire = reader.GetDecimal(13),
                        PrixTTC = reader.GetDecimal(14),
                        CodeBureau = reader.GetString(15),
                        Annee = reader.GetString(16),
                        NumeroDecision = reader.GetString(17),
                        NumeroOrdre = reader.GetString(18),
                        FactureNumber = null
                    });
                }
            }
